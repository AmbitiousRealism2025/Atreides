# Context: Session Continuity (Tasks 4.1 - 4.2)
...
## Task 4.1: Session Start Protocol
...
### Task 4.1 (Session Start)
- [ ] 4-step protocol defined
- [ ] Read context step
- [ ] Check todos step
- [ ] Review changes step
- [ ] Quick checklist provided
- [ ] Resume guidance included

### Task 4.2 (Session End)
- [ ] Completion check
- [ ] Summary template
