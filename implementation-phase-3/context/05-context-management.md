# Context: Context Management (Tasks 5.1 - 5.2)
...
## Task 5.1: Context Management Strategies
...
## Task 5.2: Critical Context Preservation Rules
...
### Task 5.1 (Strategies)
- [ ] Why context matters explained
- [ ] 3 strategies documented
- [ ] Summarization examples
- [ ] File-based memory patterns
- [ ] Structured response guidance
- [ ] Pressure signs listed

### Task 5.2 (Critical Preservation)
- [ ] What must be preserved table
- [ ] Hierarchy diagram
- [ ] Template provided
