...
import { deepMerge } from '../src/lib/config-merger.js';
...
describe('Security Verification - Manual Tests', () => {
  ...
  describe('HIGH-3: Permission Bypass Protection', () => {
    const scriptPath = join(process.cwd(), 'scripts/validate-bash-command.sh');
  ...
  describe('HIGH-4: Log Injection Prevention', () => {
    const scriptPath = join(process.cwd(), 'scripts/post-edit-log.sh');
